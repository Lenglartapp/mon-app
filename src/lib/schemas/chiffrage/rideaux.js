...
export const RIDEAUX_SCHEMA = [
    ...
    // 6
    { key: "type_confection", label: "Confection", type: "select", options: ["Pli Flamand", "Pli Creux", "Pli Plat", "Tripli", "Wave 80", "Wave 60", "Pli Couteau", "Pli Rabattu Cousu", "A Plat"], width: 150 },
    // 7
